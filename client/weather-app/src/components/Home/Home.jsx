    ...
    return (
      <div className='cardWrapper'>
            <div className='unitWrapper'>
                <button className={`metricWrapper ${unit === METRIC_UNIT ? 'active' : ''}`} onClick={() => savePreferences(METRIC_UNIT)}>metric</button>
                <button className={`${unit === IMPERIAL_UNIT ? 'active' : ''}`} onClick={() => savePreferences(IMPERIAL_UNIT)}>imperial</button>
            </div>
